        ...
        unsigned long catnumber)
{
	...
	while(i<NMEALS){	
            ...
            if(whosAtBowl[0] == -1){
                ...
                cv_wait(waitingForDish,overallLock);//weird case: wait for another valid bowl to be available
            }
          ...
          unsigned long mousenumber)
{
	...
	while(i<NMEALS){	
            ...
            if(whosAtBowl[0] == -1){
                ...
                cv_wait(waitingForDish,overallLock);//wait for valid bowl
            }
            i++;
	}
}
